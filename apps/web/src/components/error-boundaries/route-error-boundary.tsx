...
const DefaultRouteErrorFallback: React.FC<{ 
  ...
  const getErrorMessage = () => {
    if (is404Error) return { title: 'Page Not Found', description: 'The page you\'re looking for doesn\'t exist.' };
    if (is403Error) return { title: 'Access Denied', description: 'You don\'t have permission to access this page.' };
    if (is500Error) return { title: 'Server Error', description: 'Something went wrong on our end. Please try again later.' };
    return { title: 'Something went wrong', description: 'An unexpected error occurred while loading this page.' };
  };
