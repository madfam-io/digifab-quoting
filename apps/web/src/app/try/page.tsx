...
export const metadata = {
  ...
  description: 'Upload your files and get instant manufacturing quotes. Compare materials, calculate ROI, and optimize your designs in real-time.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-8">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            <a href="#upload" className="flex flex-col items-center p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
              <Upload className="w-8 h-8 mb-2" />
              <span className="font-semibold">File Upload</span>
              <span className="text-xs opacity-75">Get instant quotes</span>
            </a>
            <a href="#interactive" className="flex flex-col items-center p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
              <Zap className="w-8 h-8 mb-2" />
              <span className="font-semibold">Live Demo</span>
              <span className="text-xs opacity-75">See it in action</span>
            </a>
            <a href="#diy" className="flex flex-col items-center p-4 bg-white/10 rounded-lg hover:bg-white/20 transition-colors">
      ...
      <section id="diy" className="py-20 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Should You DIY or Use Our Service?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            You've seen the savings. You've compared the options. 
            Now let's make it happen with your actual projects.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link 
              href="/quote/new"
              className="text-white underline hover:no-underline text-lg"
            >
