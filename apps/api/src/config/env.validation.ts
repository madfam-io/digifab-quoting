...
const envSchema = z.object({
  ...
  // Feature Flags
  ENABLE_SUPPLIER_PORTAL: z.string().transform(v => v === 'true').default('false'),
  ENABLE_SUSTAINABILITY_SCORING: z.string().transform(v => v === 'true').default('true'),
  ENABLE_NDA_TRACKING: z.string().transform(v => v === 'true').default('true'),
