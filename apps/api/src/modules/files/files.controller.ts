...
export class FilesController {
  ...
  async confirmUpload(
    ...
    await this.filesService.confirmUpload(req.user.tenantId, fileId, dto.ndaAcceptanceId);
  }
  ...
  @ApiOperation({
    summary: 'Delete file',
    description:
      'Delete a file from storage. Files associated with active quotes cannot be deleted.',
  })
  @ApiParam({
    name: 'id',
    description: 'File ID',
