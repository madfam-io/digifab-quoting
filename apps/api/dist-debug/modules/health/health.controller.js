...
var HealthController = function () {
    ...
    var _detailed_decorators;
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(redisService, prismaService) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.prismaService.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT 1"], ["SELECT 1"])))];
                        case 2:
                            _a.sent();
                        ...
                        case 4:
                            ...
                            allReady = Object.values(checks).every(function (check) { return check === true; });
                            return [2 /*return*/, {
        ...
        HealthController_1.prototype.detailed = function () {
            return __awaiter(this, void 0, void 0, function () {
                var redisStats, health;
                return __generator(this, function (_a) {
                    redisStats = this.redisService.getStatistics();
                    health = {
                        status: 'ok',
                        timestamp: new Date().toISOString(),
                        uptime: process.uptime(),
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Health check' })];
        _ready_decorators = [(0, common_1.Get)('ready'), (0, swagger_1.ApiOperation)({ summary: 'Readiness check' })];
        _detailed_decorators = [(0, common_1.Get)('detailed'), (0, swagger_1.ApiOperation)({ summary: 'Detailed health check with cache statistics' })];
        ...
        __esDecorate(_classThis, null, _detailed_decorators, { kind: "method", name: "detailed", static: false, private: false, access: { has: function (obj) { return "detailed" in obj; }, get: function (obj) { return obj.detailed; } }, metadata: _metadata }, null, _instanceExtraInitializers);
