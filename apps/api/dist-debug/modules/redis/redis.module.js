...
var quote_cache_service_1 = require("./quote-cache.service");
...
var RedisModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            imports: [tenant_module_1.TenantModule, logger_module_1.LoggerModule],
            controllers: [cache_controller_1.CacheController],
            providers: [redis_service_1.RedisService, cache_service_1.CacheService, quote_cache_service_1.QuoteCacheService, cache_interceptor_1.CacheInterceptor],
            exports: [redis_service_1.RedisService, cache_service_1.CacheService, quote_cache_service_1.QuoteCacheService, cache_interceptor_1.CacheInterceptor],
        })];
