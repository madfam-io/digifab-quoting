...
export abstract class BasePricingCalculator {
  ...
  protected calculateMaterialCost(usage: MaterialUsage): Decimal {
    ...
    const massKg = new Decimal(usage.grossVolumeCm3)
  ...
  protected calculateSustainability(
    ...
    const wastePercent = ((materialUsage.grossVolumeCm3 - materialUsage.netVolumeCm3) / 
                         materialUsage.grossVolumeCm3) * 100;
